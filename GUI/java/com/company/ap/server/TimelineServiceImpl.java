...
public class TimelineServiceImpl implements TimeLineService , Serializable {
     ...
     */
    public String twitsFollowing(com.company.ap.server.UserAccount me){
     ...
     */
    public String twitLike(com.company.ap.server.UserAccount me){
     ...
     */
    public String retweetedTwits(com.company.ap.server.UserAccount me){
        ArrayList<Twit> result=new ArrayList<>();
        for (UserAccount following:me.getFollowing())
            for (Twit twit:following.getTwits())
     ...
     */
    public String replyTwits(com.company.ap.server.UserAccount me, com.company.ap.server.Twit num){
